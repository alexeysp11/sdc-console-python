...
In this program I am going to implement the Kalman filter for Self Driving Cars Control System.
I'm going to get current position, velocity and acceleration to predict position and velocity
in the next 0, 1, 2, 3, 4, 5, 10, 15, 20 seconds. 
"""
...
class KalmanFilter:
    def __init__(self, truth_value, init_guess, n_iter):
        ...
        self.n_iter = n_iter + 1 # because estimation array includes init_guess  
    ...
    def estimate(self):
        ...
        process_var = sigma / 20 # process variance Q
